...
[[nodiscard]] std::string replace_all(std::string_view str,
                                      std::string_view from,
                                      std::string_view to);

/// Check if string starts with prefix.
[[nodiscard]] bool starts_with(std::string_view str,
                               std::string_view prefix) noexcept;

/// Check if string ends with suffix.
[[nodiscard]] bool ends_with(std::string_view str,
                             std::string_view suffix) noexcept;

/// Check if string contains substring.
[[nodiscard]] bool contains(std::string_view str,
